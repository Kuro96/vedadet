...
train_engine = dict(
    ...
    criterion=dict(
        ...
        loss_iou=dict(
            typename='CrossEntropyLoss', use_sigmoid=True, loss_weight=1.0),
        train_cfg=dict(
            assigner=dict(
...
# 6. checkpoint
weights = dict(filepath='workdir/tinaface/epoch_142_weights.pth')
optimizer = dict(filepath='workdir/tinaface/epoch_142_optim.pth')
meta = dict(filepath='workdir/tinaface/epoch_142_meta.pth')
